        ...
        {concerts && concerts.length > 0 ? (
            <>
                ...
                <div className="flex flex-col">
                    {concerts.slice(0, 5).map((concert) => (
                        <motion.a
                            ...
                            className="group relative px-6 py-6 max-lg:px-4 max-md:px-5 max-md:py-5 border-y border-primary/20 overflow-hidden"
                        >
                            <motion.div
                                layout
                                transition={{
                                ...
                                className="flex items-center w-full max-md:flex-col max-md:items-start max-md:gap-2"
                            >
                                {/* Date */}
                                <motion.div
                                    layout
                                ...
                                <motion.div
                                    layout
                                    className="flex-1 min-w-0 px-8 max-lg:px-4 max-md:px-0 text-left"
                                >
                ...
                <motion.a
                    ...
                    className="group relative w-full py-6 max-md:py-5 overflow-hidden flex items-center justify-center cursor-pointer mt-8"
                >
                    {/* Default State */}
