...
const Navbar = () => {
  ...
  return (
    <div className="w-full flex justify-center text-primary text-md">
      {/* Desktop Navbar */}
      <nav className="max-md:hidden z-[9998] fixed top-5 py-6 px-6 flex justify-center rounded-full bg-[rgba(41,69,106,0.5)] border border-primary backdrop-blur-lg z-50">
